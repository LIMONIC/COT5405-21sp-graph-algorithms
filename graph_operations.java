...
public class graph_operations {
     ...
     */
    public Map<Integer,List<Integer>> shortest_paths(int s, Map<Integer,List<Integer>> graph) {
     ...
     */
    private void getPath(int v, Set<Integer> visited, Map<Integer, Integer> dist, PriorityQueue<Vertex> pq, Map<Integer,List<Integer>> result, Map<Integer,List<Integer>> graph)
    {
        int edgeWeight = -1;
        int newDis = -1;
